...
$quicklog.WriteLog("Action Message with propture test @{pt:{path=G:/devspace/projects/powershell/_repos/quicklog/libs/quicklog-example.ps1}} @{pt:{mysecon=this}}", "action" , $false)
...
$quicklog.WriteLog("Action Message @{pt:{unicode=#1F41F}} ColorTune {ct:gray:This is blue in color} and @{pt:{unicode=#1F41F}}", "action" , $true)
...
$quicklog.WriteLog("success Message with propture @{pt:{unicode=#1F41F}} {ct:green:This is green color} is a submessage", "success" , $true)
